    ...
    <div className="min-h-screen bg-[#faf7f2] text-[#2a2419]">
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-6 py-20 md:grid-cols-2 md:items-center md:py-28">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a href={WA_URL} target="_blank" rel="noopener noreferrer" className="rounded-full bg-[#1e3a2b] px-7 py-3 text-sm font-medium text-[#faf7f2] transition hover:bg-[#2a5140]">
                Konsultasi Gratis
              </a>
      ...
      <section id="products" className="border-t border-[#e8dfd0] bg-[#f5efe4]/50">
        <div className="mx-auto max-w-6xl px-6 py-20">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            {products.map((p) => (
              <article key={p.name} className="group flex flex-col overflow-hidden rounded-3xl border border-[#e8dfd0] bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
                ...
                <div className="flex flex-1 flex-col p-6">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-2">
                    <a href={WA_URL} target="_blank" rel="noopener noreferrer" className="rounded-full bg-[#1e3a2b] px-4 py-2.5 text-center text-sm font-medium text-[#faf7f2] transition hover:bg-[#2a5140]">Pesan WA</a>
      ...
      <section id="contact" className="border-t border-[#e8dfd0] bg-[#1e3a2b] text-[#faf7f2]">
        <div className="mx-auto max-w-4xl px-6 py-20 text-center">
          ...
          <a href={WA_URL} target="_blank" rel="noopener noreferrer" className="mt-8 inline-flex items-center gap-2 rounded-full bg-[#c9a84c] px-8 py-3 text-sm font-semibold text-[#1e3a2b] transition hover:bg-[#dbbe6b]">
            Chat via WhatsApp →
          </a>
        </div>
      </section>
      ...
      <a href={WA_URL} target="_blank" rel="noopener noreferrer" aria-label="Chat via WhatsApp" className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition hover:scale-110">
